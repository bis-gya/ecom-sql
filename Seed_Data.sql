-- ---------- Seed Data ----------
-- Customers
INSERT INTO training_ecom.customers (full_name, city, signup_date, email) VALUES
...
-- Products
INSERT INTO training_ecom.products (product_name, category, unit_price, active) VALUES
...
-- Orders
INSERT INTO training_ecom.orders (customer_id, order_date, status) VALUES
...
-- Order Items
INSERT INTO training_ecom.order_items (order_id, product_id, quantity, unit_price) VALUES
(1,1,1,1999.00),
(1,3,3,199.00),
(1,5,1,599.00),
(2,2,1,1499.00),
...
-- Payments
INSERT INTO training_ecom.payments (order_id, amount, method, paid_at) VALUES
